...
import { CloverCanvas } from '../worker/canvas-clover-worker'
...
const CloverAnimation = () => {
  const [cloverCanvas, setCloverCanvas] = useState<NullablePossible<CloverCanvas>>(null)
  ...
  }, [canvasRef, canvasWrapperRef, backgroundCanvasRef])
  ...
  }, [cloverCanvas, resizeBackground, resizeCanvas])
