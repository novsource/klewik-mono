...
} from '../use-url-search-param/use-url-search-param'
...
export type UseUrlSearchParamsSetOptions = {
...
export type UseUrlSearchParamsOptions<Value> = {
...
export type UseUrlSearchParamsReturn<Value> = {
...
export type UseUrlSearchParams = {
  <Value>(
    key: string,
 ...
 * @param {UrlSearchParamsMode} [options.mode] The mode to use for the URL ('history' | 'hash-params' | 'hash')
 * @param {'push' | 'replace'} [options.write] The mode to use for writing to the URL
...
export const useUrlSearchParams = (<Value extends UrlParams>(
  ...
  const deserializer = (value: string) => {
    ...
    if (value === 'undefined')
      return undefined as unknown as Value[keyof Value]
