...
export const tableBaseVariants = cva(
  'w-full caption-bottom text-[15px] text-white'
)
...
export const tableCellVariants = cva([
  ...
  'before:top-1/2 before:-translate-y-1/2 before:left-0 before:bg-dark before:-z-10 before:w-full data-[hovered=true]:before:bg-dark-accent',
  'before:py-[22px]',
])
