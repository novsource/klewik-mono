  ...
  return (
    ...
    >
      <g clip-path="url(#clip0_1674_1053)">
        <g filter="url(#filter0_d_1674_1053)">
          <path
            ...
            fill={
              props.gradient ? 'url(#pencil-icon-gradient)' : 'currentColor'
            }
          />
          <path
      ...
      <defs>
        ...
        <linearGradient id="pencil-icon-gradient" x1="1.33398" y1="7.99967" x2="14.6673" y2="7.99967" gradientUnits="userSpaceOnUse">
