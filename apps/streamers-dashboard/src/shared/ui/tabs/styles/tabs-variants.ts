...
export const tabsListVariants = cva(
  'relative inline-flex h-9 tablet:h-10 items-center justify-center rounded-large p-1',
)
...
export const tabsTriggerRunnerVariants = cva(
  'absolute h-8 max-tablet:h-7.5 rounded-medium bg-dark-accent transition-all tabs-runner-shadow border-1 border-gray/20',
)
