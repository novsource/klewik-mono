...
import type { DialogBackdropVariantsProps, DialogContentVariantsProps, DialogTitleVariantsProps } from '../styles/dialog-variants'
...
export const DialogTrigger = ({ ref, ...props }: DialogTriggerProps & { ref?: React.RefObject<ElementRef<typeof DialogPrimitive.Trigger> | null> }) => {
	const { className, ...restProps } = props
